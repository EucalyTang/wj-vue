<template>
	<div>
		...
		<button type="button" class="op-icon el-icon-documrnt" :title="'摘要/封面'" slot="left-toolbar-after" @click="dialogVisible = true"></button>
		<mavon-editor v-model="article.articleContentMd" style="height: 100%;" ref=md @save="saveArticles" fontSize="16px"></mavon-editor>
		<el-dialog :visible.sync="dialogVisible" width="30%">
			...
			<div style="margin-top: 20px;">
				<el-input v-model="article.articleCover" auto-complete="off" placeholder="图片 URL"></el-input>
