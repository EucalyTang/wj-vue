  ...
  <div>
    <el-dialog title="修改用户信息" :visible.sync="dialogFormVisible">
      <el-form v-model="selectedUser" style="text-align: left" ref="dataForm">
        ...
        <el-form-item label="邀请码" label-width="120px" prop="inviteCode">
          <label>{{ selectedUser.inviteCode }}</label>
        </el-form-item>
    ...
    <el-card style="margin: 18px 2%;width: 95%">
      ...
      >
        ...
        <el-table-column prop="inviteCode" label="邀请码" fit>
        </el-table-column>
